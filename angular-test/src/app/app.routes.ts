...
export const routes: Routes = [
  // Dashboard tendra la importación por defecto. Para ello, en el componente declarado, tendremos que añádir 'default' a la clase export.
  { path: 'dashboard', loadComponent: () => import('./dashboard/dashboard.component'), 
    children: [
      ...
      { path: 'users-list', title: "Users List", loadComponent: () => import('./dashboard/pages/users/users.component') },
